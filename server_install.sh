...
docker run --name nginxproman -p 8181:8181 -p 8080:8080 -p 4443:4443 -v /docker/appdata/nginx-proxy-manager:/config:rw --net=net_localhost -d jlesage/nginx-proxy-manager
